...
// This is the first version of the not-found.tsx script, the present version in use is the second version,
// but i still kept this because i actually like it. The difference is in how the inverted border radius is handled .
